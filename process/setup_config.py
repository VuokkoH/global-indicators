...
osm_input_date = 20220701  # Date at which OSM download was current
gtfs_analysis_date = 20221208 # Date on which the GTFS data were analysed and output; yyyy-mm-dd string
output_date = 20221202  # Date at which the output data are (or were recorded as) prepared
...
cities = [
    {"cityname": "helsinkifutura", "region": "fi", "crs": "epsg:32635"},
    {"cityname": "lahtifutura", "region": "fi", "crs": "epsg:32635"},
    {"cityname": "tamperefutura", "region": "fi", "crs": "epsg:32635"},
    {"cityname": "turkufutura", "region": "fi", "crs": "epsg:32635"},
]
